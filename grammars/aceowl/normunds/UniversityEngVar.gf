...
concrete UniversityEngVar of University = OntologyEngDef ** open ResEng in {
	flags
		optimize = all_subs ;
		optimize = values ;
	...
	lin
		...
		enrolls = mkParticiple "enrolled" Obj | mkVerb "enroll" Obj ;
		enrolledIn = mkParticiple "enrolled" In Place | mkVerb "enroll" In Place ;
